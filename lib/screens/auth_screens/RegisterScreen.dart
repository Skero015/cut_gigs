...
class _RegisterScreenState extends State<RegisterScreen> {
 ...
 // final TextEditingController _country = new TextEditingController();
  ...
  void signUp({String firstName,
    ...
    if (_formKeyRegister.currentState.validate() && title.isNotEmpty && country.isNotEmpty) {
      try {
        ...
        if(title.trim().isEmpty || country.trim().isEmpty){
          _scaffoldKeyRegister.currentState.showSnackBar(SnackBar(
            content: new Text("Please make sure you have entered all fields"),
